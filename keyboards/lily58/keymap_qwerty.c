 ...
 * `-----------------------------------------/       /    \       \-----------------------------------------'
 *                   |LOWER |LAlt/⌥|GUI/⌘|| /Space  /      \ Enter \  |RGUI/⌘ |RAlt/⌥| | RAISE |
 *                   |      |      |      |/       /        \       \ |       |      |       |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
      ...
      MO(1), KC_LALT, KC_LGUI, KC_SPC,                              KC_ENT, MO(2), KC_MPLY, MO(2)
),

/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | Mute |Vol - |Vol + | Play |  Rwd |  Fwd |                    |      |      |      |  -/_ | +/=  |  DEL |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 ...
 */
[_LOWER] = LAYOUT(
  KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_MRWD, KC_MFFD,           KC_NO, KC_NO, KC_NO, KC_MINS, KC_PLUS, KC_DEL,
 ...
 */
  [_ADJUST] = LAYOUT(
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO, SS_STAEMAIL, KC_NO, KC_NO, SS_GMAIL,            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
